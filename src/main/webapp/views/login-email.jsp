...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .divider { display: flex; align-items: center; margin: 1.5rem 0; color: #5f6368; font-size: 0.85rem; }
        ...
        .email-otp-icon { text-align: center; margin-bottom: 1rem; color: #1a1a1a; }
        .email-otp-icon svg { width: 48px; height: 48px; }
    </style>
</head>
<body>
<header class="header">
