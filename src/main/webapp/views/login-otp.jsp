    ...
    <div class="container">
        <div class="center">
            <div class="card">
                ...
                <div class="resend-section hidden" id="resendSection">
                    Không nhận được mã?
                ...
                <div class="helper">
                    <a href="${pageContext.request.contextPath}/send-otp">Nhập sai email? Đăng nhập lại</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    const countdownInterval = setInterval(() => {
        let count = parseInt(countdownDisplay.textContent);
        if (count > 1) {
            countdownDisplay.textContent = count - 1;
        } else {
